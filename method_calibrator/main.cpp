...
//----------------------------------------------------------------------------------------------------------------
                    //cv::imshow("debug1", frame_resized);
                    cv::Mat greenMask_blob = Mask.greenMask;
                    cv::imshow("debug1", frame);
                    //cv::imshow("debug2", whiteMask_blob);
                    //cv::Mat gray;
                    //cv::cvtColor(greenMask_blob, gray, CV_BGR2GRAY);

                    blob test;
                    test.test_blob(greenMask_blob);
...
/*----------------------------------------------------------------------------------------------------------------*/
    ...
    if(std::atoi(argv[3])){
        for(double hough_param1 = 20; hough_param1 < 62; hough_param1=hough_param1+2){
            for(double hough_param2 = 1; hough_param2 < 3; hough_param2=hough_param2+2){
                ...
                while(1){
                    ...
                    frame_resized.copyTo(frame_resized_masked, greenROI);
// /*----------------------------------------------------------------------------------------------------------------*/
//                     cv::Mat whiteMask_blob = Mask.whiteMask;
//                     blob test;
//                     test.test_blob(whiteMask_blob);
// /*----------------------------------------------------------------------------------------------------------------*/

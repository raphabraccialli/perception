...
int main(int argc, char *argv[]){
    ...
    if(std::atoi(argv[3])){
        for(double hough_param1 = 40; hough_param1 < 41; hough_param1=hough_param1+2){
            for(double hough_param2 = 7; hough_param2 < 8; hough_param2=hough_param2+2){
                cap.set(CV_CAP_PROP_POS_FRAMES, 0);
                houghCirclesContrast hough(hough_param1, hough_param2, (int)MIN_RADIUS/2, (int)MIN_RADIUS, (int)MAX_RADIUS);
